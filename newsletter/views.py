...
class BulkActionView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        # Debug logging
        print(f"BulkActionView - Action: {action}")
        print(f"BulkActionView - Subscriber IDs: {subscriber_ids}")
        ...
        try:
            ...
            print(f"BulkActionView - Found {subscribers.count()} subscribers")
            ...
            if action == 'activate':
                ...
                print(f"BulkActionView - About to delete {count} subscribers")
                subscribers.delete()
            ...
            print(f"BulkActionView - Error: {str(e)}")
